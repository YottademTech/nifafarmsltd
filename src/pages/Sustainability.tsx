...
export default function Sustainability() {
  return (
    <>
      ...
      />
      {/* Page Hero */}
      <section className="relative bg-forest-800 pt-36 pb-24 grain-overlay overflow-hidden">
        <div className="page-hero-bg">
          <img src={IMAGES.cassavaProcessing} alt="" aria-hidden="true" />
          <div className="absolute inset-0 bg-gradient-to-b from-forest-800/30 via-forest-800/50 to-forest-800/85" />
        </div>
        <div className="container-wide relative z-10">
          <ScrollReveal>
            <p className="eyebrow text-gold-400/70 mb-5">Our Commitments</p>
          </ScrollReveal>
      ...
      <section className="section-gap bg-white">
        <div className="container-wide">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
            <div>
              <ScrollReveal>
                <p className="eyebrow text-forest-600 mb-4">Our Approach</p>
              </ScrollReveal>
            ...
            <ScrollReveal delay={0.1} y={30}>
              <FarmImage
                ...
                alt="Community members processing cassava at Nifa Farms"
                className="aspect-[16/10] mb-px"
              />
              <div className="grid grid-cols-2 gap-px bg-stone-100">
                {WORKFORCE.map(({ label, value }) => (
                  <div key={label} className="bg-stone-50 p-8">
                    <p className="font-display text-4xl sm:text-5xl font-semibold text-forest-700 mb-2">{value}</p>
                    <p className="text-stone-400 text-sm tracking-wide uppercase">{label}</p>
                  </div>
                ))}
              </div>
      ...
      <section className="section-gap bg-stone-50">
        <div className="container-wide">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 mb-16 items-end">
            <div>
          <ScrollReveal>
            <p className="eyebrow text-forest-600 mb-4">Four Pillars</p>
          </ScrollReveal>
          <ScrollReveal delay={0.06}>
            ...
            <ScrollReveal delay={0.1}>
              <FarmImage
                ...
                alt="Lush cocoa and cassava crops at Nifa Farms"
                  ...
                  <div className="bg-white p-10 lg:p-14 grid grid-cols-1 lg:grid-cols-3 gap-10">
                    <div className="lg:col-span-1">
                      <div className="flex items-center gap-3 mb-4">
                        ...
                        <span className="eyebrow text-forest-600">{String(i + 1).padStart(2, '0')}</span>
                      </div>
                      <h3 className="font-display text-2xl font-semibold text-forest-950 mb-2">
                        {pillar.title}
                      </h3>
                      <p className="text-gold-600 text-sm font-medium italic">{pillar.sub}</p>
                    </div>
                    <div className="lg:col-span-2">
                      <p className="text-stone-500 text-base leading-relaxed mb-7">{pillar.body}</p>
      ...
      {/* CTA */}
      <section className="relative section-gap-sm bg-forest-950 grain-overlay overflow-hidden">
        <div className="page-hero-bg">
          <img src={IMAGES.officeControl} alt="" aria-hidden="true" className="opacity-15" />
        ...
        <div className="container-wide relative z-10 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10">
          <div>
            <ScrollReveal>
              <h2 className="display-heading text-white text-3xl sm:text-4xl lg:text-5xl max-w-xl">
