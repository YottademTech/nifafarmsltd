        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-16 pb-16 border-b border-white/10">
          ...
          <div className="lg:col-span-1">
            <Link to="/" className="flex flex-col leading-none mb-6 group">
              <span className="font-display font-semibold text-2xl tracking-wide">NIFA FARMS</span>
              <span className="text-[10px] tracking-[0.22em] uppercase text-gold-400/70 mt-0.5">Limited</span>
            </Link>
            <p className="text-white/45 text-sm leading-relaxed max-w-xs">
              Ghana's premier cocoa and shea nuts processing enterprise. From farm to global market.
            </p>
            <p className="text-gold-500 text-xs tracking-[0.12em] uppercase mt-6 font-medium">
          ...
          {/* Navigation */}
          <div>
            <p className="eyebrow text-white/30 mb-6 text-[10px]">Company</p>
          ...
          {/* Products */}
          <div>
            <p className="eyebrow text-white/30 mb-6 text-[10px]">Products</p>
            <ul className="space-y-3">
              {PRODUCT_LINKS.map((p) => (
                <li key={p.id}>
                  <Link
          ...
          {/* Contact */}
          <div>
            <p className="eyebrow text-white/30 mb-6 text-[10px]">Contact</p>
            ...
            <a
              href={`mailto:${COMPANY_INFO.email}`}
              className="inline-flex items-center gap-1.5 mt-8 text-gold-400 text-sm font-medium hover:text-gold-300 transition-colors duration-200"
            >
              Send us a message
