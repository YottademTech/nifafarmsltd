...
export const PRODUCT_IMAGES: Record<string, string> = {
  'cocoa-liquor': IMAGES.cocoaWarehouse,
  'cocoa-butter': IMAGES.cocoaWarehouse,
  'cocoa-powder': IMAGES.cocoaWarehouse,
  'cocoa-shell': IMAGES.warehouseSacks,
  'shea-butter': IMAGES.warehouseSacks,
  'shea-oil': IMAGES.warehouseSacksAlt,
  'shea-stearin': IMAGES.warehouseBoxes,
